...
SECRET_KEY = 'django-insecure-jwog(=p#h250dprgiy_ikka-xb=_bu(t69q3gtgmb6jl5pf+bt'
...
REST_FRAMEWORK = {
    ...
    # Optional: Also allow form rendering in browsable API
